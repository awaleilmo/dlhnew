...
@section('konten')
    ...
    <div id="page-content">
        ...
        <div class="container">
            <div id="page-title">
                <h2>{{__('Dashboard Data Jenis TPS')}}</h2>
                <p>{{__('Tampilan menu data Jenis TPS')}}</p>
            </div>
        </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <input id="jenis" name="jenis" type="text" class="form-control" required autocomplete="off" placeholder="Jenis TPS">
                    </div>
                </div>
                <br>
                <div class="row">
        ...
        <script>
            ...
            $('body').on('click', '.edit-user', function () {
                ...
                $.get("{{url('/sjtps')}}"+ '/' +user_id, function (data) {
                    document.getElementById("pelaku").style.display='';
                    $('#btn-submit').addClass('hidden');
                    $('#btn-edit').removeClass('hidden');
                    $('#jenis').val(data.jenistps);
                    $('#unit').val(data.unit);
                    $('#id').val(data.id);
                    var oTable = $('#datatable1').dataTable();
                    oTable.fnDraw(false);
