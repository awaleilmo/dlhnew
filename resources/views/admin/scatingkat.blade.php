...
@section('konten')
    ...
    <div id="page-content">
        ...
        <div class="container">
            <div id="page-title">
                <h2>{{__('Dashboard Sekolah Calon Adwiyata Tingkat')}}</h2>
                <p>{{__('Tampilan menu sekolah calon adwiyata tingkat')}}</p>
            </div>
        </div>
        <form id="pelaku"  method="post" action="javascript:void(0)" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <input id="penghargaan" name="penghargaan" type="text" class="form-control" required autocomplete="off" placeholder="Penghargaan">
                    </div>
                </div>
                <br>
                <div class="row">
        ...
        <script>
            ...
            $('body').on('click', '.edit-user', function () {
                ...
                $.get("{{url('/sscatingkat')}}"+ '/' +user_id, function (data) {
                    ...
                    $('#penghargaan').val(data.penghargaan);
                    $('#id').val(data.id);
                    var oTable = $('#datatable1').dataTable();
                    oTable.fnDraw(false);
                })
            ...
            var table = $("#datatable1").dataTable({
                ...
                columns: [
                    ...
                    { data: 'penghargaan', name: 'penghargaan'},
