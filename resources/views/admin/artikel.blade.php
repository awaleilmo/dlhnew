...
@section('konten')
    <div id="page-content">
        ...
        <div class="container">
            <div id="page-title">
                <h2>{{__('Dashboard Pojok Warga LH')}}</h2>
                <p>{{__('Tampilan menu pojok warga LH')}}</p>
            </div>
        </div>
        ...
        <form class="panel" id="editor" style="display: none" method="post" action="{{url('eartikel')}}" enctype="multipart/form-data">
                @csrf
                <div class="panel-body">
                    <div class="example-box-wrapper">
