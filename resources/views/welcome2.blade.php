...
<div id="layerslider" style="width: 100%; height: 600px;">
    ...
    <div class="ls-slide" data-ls="
        ...
        <div class="col-md-6">
        <h2 class="hero-heading font-black ls-l" style="
					top: 33%;
					left: 0;
					height: 10%;
                    text-align: right;
        ...
        <p class="hero-text font-black ls-l" style=" color: black; top: 50%;left: 0;width: 600px;font-size: 20px;line-height: 1.6em;text-align: left;" data-ls="offsetxin:150; durationin:1500; easingin:easeInOutQuart; rotateyin:40; offsetxout:150; rotateyout:40;">
    ...
    <div class="ls-slide row" data-ls="slidedelay: 4000; transition2d: 6,37,19;">
        <div class="col-md-6">
        <h2 class="hero-heading font-black ls-l"
            style="
					top: 29%;
					left: 0;
                    padding: 0;
        ...
        <p class="hero-text font-black ls-l"
           style="
					top: 46%;
					left: 0;
					padding: 0;
        ...
        <div class="col-md-6">
        <img src="../../img/undraw_Throw_away_re_x60k.png" class="ls-l"
             style="
					top: 55%;
					left: 80%;
					width: 45%;
    ...
    <div class="ls-slide row" data-ls="slidedelay: 7000; transition3d: 22;">
        ...
        <div class="col-md-4">
            <img src="../../img/undraw_Selection_re_poer.png" class="ls-l" style="width:40%; height:65%;border-radius: 20px; bottom:0px;left:50px; padding-top: 50px" data-ls="durationin:1500;delayin:10;rotatein:20;rotatexin:30;scalexin:3;scaleyin:3;transformoriginin:left 50% 0;durationout:750;rotateout:20;rotatexout:-30;scalexout:0;scaleyout:0;transformoriginout:left 50% 0;" />
         </div>
        <div class="col-md-4">
        <p class="ls-l" style="top:80px;left:599px;height:40px;padding-right:15px;padding-left:15px;font-size:24px;line-height:37px;background:rgba(255,255,255,0.1);border-radius:4px;white-space: nowrap;" data-ls="durationin:1500;delayin:500;rotatein:20;rotatexin:30;scalexin:3;scaleyin:3;transformoriginin:left 50% 0;durationout:750;rotateout:20;rotatexout:-30;scalexout:0;scaleyout:0;transformoriginout:left 50% 0;">
            Visi
        </p>
        <p class="ls-l" style="top:140px;left:599px;font-size:18px;margin-top: 5px;" data-ls="offsetxin:0;durationin:1500;delayin:2300;rotateyin:90;skewxin:60;transformoriginin:25% 50% 0;offsetxout:100;durationout:750;skewxout:60;">
            "Terwujudnya Kota Peradaban yang Berdaya dan Berbudaya"
        </p>
        <p class="ls-l" style="top:180px;left:599px;height:40px;padding-right:15px;padding-left:15px;font-size:24px;line-height:37px;background:rgba(255,255,255,0.1);border-radius:4px;white-space: nowrap;" data-ls="durationin:1500;delayin:1000;rotatein:20;rotatexin:30;scalexin:1.5;scaleyin:1.5;transformoriginin:left 50% 0;durationout:750;rotateout:20;rotatexout:-30;scalexout:0;scaleyout:0;transformoriginout:left 50% 0;">
            Misi
        </p>
        <p class="ls-l" style="top:240px;left:599px;font-size:18px;margin-top: 5px;" data-ls="offsetxin:0;durationin:1500;delayin:2600;rotateyin:90;skewxin:60;transformoriginin:25% 50% 0;offsetxout:100;durationout:750;skewxout:60;">
            Menguatkan Peradaban Berbasis Nilai-Nilai Kemanusiaan.
        </p>
        <p class="ls-l" style="top:280px;left:599px;font-size:18px;margin-top: 5px;" data-ls="offsetxin:0;durationin:1500;delayin:3000;rotateyin:90;skewxin:60;transformoriginin:25% 50% 0;offsetxout:100;durationout:750;skewxout:60;">
            Meningkatkan Sarana Prasarana Daerah yang Berwawasan Lingkungan.
        </p>
        <p class="ls-l" style="top:320px;left:599px;font-size:18px;margin-top: 5px;" data-ls="offsetxin:0;durationin:1500;delayin:3300;rotateyin:90;skewxin:60;transformoriginin:25% 50% 0;offsetxout:100;durationout:750;skewxout:60;">
            Meningkatkan Perekonomian Daerah dan Pemberdayaan Masyarakat yang Berdaya Saing.
        </p>
            <p class="ls-l" style="top:360px;left:599px;font-size:18px;margin-top: 5px;" data-ls="offsetxin:0;durationin:1500;delayin:3300;rotateyin:90;skewxin:60;transformoriginin:25% 50% 0;offsetxout:100;durationout:750;skewxout:60;">
