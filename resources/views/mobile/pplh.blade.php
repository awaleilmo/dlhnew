...
@section('content')
            <h2 class="hero-heading wow fadeInDown animated animated" data-wow-duration="0.6s" style="visibility: visible; animation-duration: 0.6s;">Bidang Penataan dan Penaatan Perlindungan Pengelolaan Lingkungan Hidup</h2>
