    ...
    <div class="hero-box bg-white hero-box-smaller ">
        <div class="container">
            ...
            <ul class="tabs-nav" role="tablist" >
                <li >
                    <a href="#tentang" style=" color:black; font-size: 15px; border: 1px solid #3e4855; " role="tab" data-toggle="tab">Tentang Adwiyata</a>
                </li>
                <li >
                    <a href="#sca" style=" color:black; font-size: 15px; border: 1px solid #3e4855; " role="tab" data-toggle="tab">Sekolah Calon Adwiyata</a>
                </li>
                <li >
                    <a href="#sna" style=" color:black; font-size: 15px; border: 1px solid #3e4855; " role="tab" data-toggle="tab">Sekolah Non Adwiyata</a>
                </li>
                <li >
                    <a href="#scatingkat" style=" color:black; font-size: 15px; border: 1px solid #3e4855; " role="tab" data-toggle="tab">Sekolah Calon Adwiyata Tingkat</a>
                </li>
            </ul>
