...
<!-- Mirrored from agileui.com/demo/monarch/demo/admin-template/server-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Jul 2019 03:59:56 GMT -->
<head>
    <style>
        /* Loading Spinner */
        ...
        <div class="col-md-6 center-margin">
            <div class="server-message wow bounceInDown inverse">
                ...
                <script>
                    ...
                    <button class="btn btn-lg btn-success" onclick="goBack()">Return to previous page</button>
