...
<!-- Mirrored from agileui.com/demo/monarch/demo/admin-template/server-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Jul 2019 03:59:56 GMT -->
<head>
    <style>
        /* Loading Spinner */
    ...
    <div class="center-content row">
        ...
        <div class="col-md-6 center-margin">
            <div class="server-message wow bounceInDown inverse">
                <h1>Maintenance 503</h1>
                <h2>Sedang Dalam Perbaikan Syntax dan Tidak Bisa di Akses Untuk Beberapa Saat.</h2>
                <p>Coba lagi dalam beberapa jam atau hubungi administrator situs web.</p>
            </div>
        </div>
